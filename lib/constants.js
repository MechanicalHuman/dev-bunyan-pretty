...
Constants.INPM2 =
  'PM2_HOME' in env || 'PM2_JSON_PROCESSING' in env || 'PM2_CLI' in env
...
Constants.CORE_FIELDS = ['pid', 'hostname', 'name', 'level', 'time', 'v']

Constants.HTTP_FIELDS = ['req', 'res']
Constants.ERROR_FIELDS = ['err']
Constants.SOURCE_FIELDS = ['src']
Constants.OMIT_FIELDS = [...Constants.CORE_FIELDS, 'msg']
